...
namespace InterfaceMocks
{
    ...
    public sealed class MockMethodWithParam<TParam> : MockMethodBase, IMockMethodWithParam<TParam>
    {
        ...
        private MockMethodWithParam(string name, IStickyLastCollection<Action> lambdas, IStickyLastCollection<TParam> values, IAsserter asserter) : base(name)
        {
            _name = name;
            _lambdas = lambdas;
            _values = values;
    ...
    public interface IMockMethodWithParam<TParam>
    {
        ...
        /// <summary>
        /// Called when the mockd method is invoked.
        /// </summary>
        /// <param name="value">The value the method was invoked with</param>
        void Invoke(TParam value);
        /// <summary>
        /// Called when the mockd method is invoked async.
        /// </summary>
        /// <param name="value">The value the method was invoked with</param>
