...
{
    public class FakeMethod : ISignature
    {
        ...
        public FakeMethod(IMethod methodDeclaration, IInterface theInterface) :
            this(methodDeclaration, new MethodName(methodDeclaration, theInterface), new MethodArgs(methodDeclaration))
        { }

        public FakeMethod(IMethod methodDeclaration, IMethodName methodName, IMethodArgs methodArgs)
        {
