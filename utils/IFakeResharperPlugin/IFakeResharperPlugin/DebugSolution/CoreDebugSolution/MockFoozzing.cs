...
namespace CoreDebugSolution
{
    ...
    public interface IFromMe<T> : IFakeMethods<T>, ITheRestOfThings<T>
    {
        void NeedsMe();
    }

    public partial class FakeFromMe<T> : IFromMe<T> {
        ...
        private FakeMethodWithParamAndResponse<Tuple<char, string, IExampleType>, int> _paramTupleResponseType;
        ...
        public class Builder {
            ...
            private readonly FakeMethodWithParamAndResponse<Tuple<char, string, IExampleType>, int> _paramTupleResponseType = new FakeMethodWithParamAndResponse<Tuple<char, string, IExampleType>, int>("FakeFakeMethodWithParamAndResponse#ParamTupleResponseType");
            ...
            private readonly FakeMethod _needsMe = new FakeMethod("FakeFromMe#NeedsMe");

            public FakeFromMe<T> Build()
            {
                return new FakeFromMe<T>
                {
                    _voidVoid = _voidVoid,
